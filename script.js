...
const locations = [
  ...
  },
  {
    ...
    text: 'The monster screams "Arg!" as it dies. You gian experience points and find gold.',
  },
  {
    name: "lose",
...
function buyWeapon() {
  if (currentWeapon < weapons.length - 1) {
    if (gold >= 30) {
      ...
      gold.innerText = "You no have a new " + newWeapon + ".";
    ...
    text.innerText =
      "!!Woo!! It seems like you already have the most powerful weapon!";
    button2.innerText = "Sell weapon for 15gold";
...
function attack() {
  ...
  text.innerText =
    " You attack it with you " + weapons[currentWeapon].name + ".";
